/**@typedef {import('../Slider/Slider.types').SliderProps} SliderProps */
...
/**
 * @typedef {[banner]} featuredBanners
 */

/**
 * @typedef {object} props
 * @property {featuredBanners} featuredBanners
 * @property {number} gap
 */

/**
 * @typedef {props & SliderProps} FeaturedBannerSliderProps
 */

/**
 * @callback CategoryGrid
 * @param {props & SliderProps} props
 */
